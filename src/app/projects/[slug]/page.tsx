    ...
    return (
        <div className="flex flex-col w-full min-h-screen bg-black text-white pt-40 pb-32">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                >
                    <motion.h1 variants={fadeUp} className="type-display text-display-sm">
                        {projectData.title}
                    </motion.h1>
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="space-y-12">
                        <div className="group space-y-4">
                            <h3 className="text-2xl font-semibold flex items-center gap-3 group-hover:text-foreground transition-colors">
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="space-y-12 rounded-2xl border border-white/[0.06] bg-transparent p-8 md:p-12">
                        <div className="group space-y-4">
                            <h3 className="text-2xl font-semibold flex items-center gap-3 group-hover:text-foreground transition-colors">
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="space-y-12">
                        <div className="group space-y-4 border-l border-white/10 pl-8 relative">
                            ...
                            <h3 className="text-2xl font-semibold group-hover:text-foreground transition-colors">Outcome Achieved</h3>
                        ...
                        <div className="group space-y-4 border-l border-white/10 pl-8 relative">
                            ...
                            <h3 className="text-2xl font-semibold group-hover:text-foreground transition-colors">Real World Relevance</h3>
                ...
                >
                    <a rel="noopener noreferrer" target="_blank" href={projectData.liveUrl} className="group flex w-full items-center justify-center gap-3 rounded-2xl bg-white px-8 py-4 font-medium tracking-wide text-black transition-opacity duration-500 ease-premium hover:opacity-90 sm:w-auto">
                    ...
                    <a rel="noopener noreferrer" target="_blank" href={projectData.codeUrl} className="flex w-full items-center justify-center gap-3 rounded-2xl border border-white/20 bg-transparent px-8 py-4 font-medium tracking-wide text-white transition-colors duration-500 ease-premium hover:bg-white/5 sm:w-auto">
